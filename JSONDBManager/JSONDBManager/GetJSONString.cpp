...
int main() {
	...
	//	outValue = "{\"db_getQuery\":\"SELECT id, login_id, authority FROM user_inf WHERE login_id = 'userName' AND password = 'password'; ", "userName\":{\"value\":\"teacher\"},\"password\":{\"value\":\"4a82cb6db537ef6c5b53d144854e146de79502e8\"},\"id\":{\"text\":\"3\"},\"authority\":{\"text\":\"10\"}}";
		//ログインチェックエラーが発生した場合
	/*	}
